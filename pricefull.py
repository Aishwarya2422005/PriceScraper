...
# Importing authentication components from app.txt
...
st.markdown("<h1>Price Comparison Tool: Amazon vs Flipkart</h1>", unsafe_allow_html=True)

if st.session_state.logged_in:
    st.write("Welcome to the authenticated section!")
